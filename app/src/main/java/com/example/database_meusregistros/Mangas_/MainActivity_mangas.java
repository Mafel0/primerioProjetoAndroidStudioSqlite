...
public class MainActivity_mangas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity_mangas.this, AddActivity_mangas.class);
                startActivity(intent);
            }
        });

        myDB = new MyDatabaseHelper(MainActivity_mangas.this);
        ...
        customAdapter = new CustomAdapter(MainActivity_mangas.this,this, livro_id, livro_titulo, livro_autor,
                livro_paginas);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(MainActivity_mangas.this));
    }
    ...
    void storeDataInArrays(){
        Cursor cursor = myDB.readAllDataManga();
    ...
    void confirmDialog(){
        ...
        builder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                MyDatabaseHelper myDB = new MyDatabaseHelper(MainActivity_mangas.this);
                myDB.deleteAllDataManga();
                //Refresh Activity
                Intent intent = new Intent(MainActivity_mangas.this, MainActivity_mangas.class);
                startActivity(intent);
                finish();
            }
        });
